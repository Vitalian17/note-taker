...
app.get("/api/notes", function(req, res) {
    ...
    let noteData = fs.readFileSync('./develop/db/db.json');
...
app.post("/api/notes", function(req, res) {
    ...
    fs.writeFile('./develop/db/db.json', JSON.stringify(currentNote), function(err) {
        if (err) throw err;
    });
});
...
app.delete("/api/notes/:title", function(req, res) {
    ...
    try {
        ...
        fs.writeFile('./develop/db/db.json', JSON.stringify(chosenNote), function(err) {
            if (err) throw err;
        });
    } catch (err) {
        var convertedData = {};
